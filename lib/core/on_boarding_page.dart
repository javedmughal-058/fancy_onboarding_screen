...
class _FancyOnBoardingScreenState extends State<FancyOnBoardingScreen>
  ...
  List<OnBoardingItemModel> onBoardingItems = const [
    OnBoardingItemModel(
      title: 'Title 1',
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Text(
                widget.subHeadingText ?? 'Sub Heading',
  ...
  List<Widget> _buildItemInfo({int activeIndex = 0}) {
    return [
      ...
      //     style: Theme.of(context).textTheme.subtitle1!.copyWith(fontSize: 20, color: Theme.of(context).primaryColor, fontWeight: FontWeight.bold),
      ...
      Center(
        child: Text(
          ...
          style: Theme.of(context)
              .textTheme
              .displaySmall!
              .copyWith(fontSize: 16, color: kLightGreyColor),
